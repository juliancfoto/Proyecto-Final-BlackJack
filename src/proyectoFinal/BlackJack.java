...
public class BlackJack extends JFrame {
	...
	public void componentes() {
		...
		// Creamos labels con las imagenes de las cartas que se le van a asignar al jugador.
		...
		// NOMBRE JUGADOR
		 ...
		 nombreJugador.setBounds(31, 269, 317, 22); contentPane.add(nombreJugador);
		...
		// Este botón es utilizado por el usuario, y pide las cartas hasta donde el quiera.
		...
		btnMostrar.addActionListener(new ActionListener() {
			// Este botón es utilizado por el usuario, y muestra las cartas pedidas por el jugador.
			public void actionPerformed(ActionEvent e) {
				...
				// Creamos un condicional para que el usuario decida que número desea si saca un AS.
				if (nRandom == 0 || nRandom == 13 || nRandom == 26 || nRandom == 39) {
					try {
						valorAS = Integer.parseInt((JOptionPane.showInputDialog("Sacaste un AS\n ¿Qué valor deseas asignarle?(1 ó 11)")));
						if (valorAS != 1 && valorAS != 11) {
							JOptionPane.showInternalMessageDialog(null, "Introduzca el número 1 o el número 11");
							valorAS = Integer.parseInt((JOptionPane.showInputDialog("Sacaste un AS\n ¿Qué valor deseas asignarle?(1 ó 11)")));
						}
					} catch (NumberFormatException e1) {
						JOptionPane.showInternalMessageDialog(null, "Introduzca el número 1 o el número 11" + e1.toString());
						valorAS = Integer.parseInt((JOptionPane.showInputDialog("Sacaste un AS\n ¿Qué valor deseas asignarle?(1 ó 11)")));
					}
					}
		...
		// Este botón es utilizado por el usuario, y deja que el usuario deje su mano como lo decidió.
		btnQuedar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Creamos números aleatorios para sacar una carta aleatoria de la baraja a la banca.
				int nRandom = (int) Math.floor(Math.random() * 51 + 1);
				String icon = barajaBJ.retornarRandom(nRandom);
				int nRandom1 = (int) Math.floor(Math.random() * 51 + 1);
				...
				if ((nRandom == 0 || nRandom == 13 || nRandom == 26 || nRandom == 39)||(nRandom1 == 0 || nRandom1 == 13 || nRandom1 == 26 || nRandom1 == 39)) {
				...
				if (cartasBanca.getValorTotal() > 21 || cartasBanca.getValorTotal() < cartasJugador.getValorTotal()) {
					JOptionPane.showMessageDialog(null, "Ganó "+ player);
						...
						|| (cartasBanca.getValorTotal() > cartasJugador.getValorTotal() && cartasBanca.getValorTotal() < 21)) {
					JOptionPane.showMessageDialog(null, "Ganó la Banca");
